module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/set_server_afk_channel.js",
  },
  ...
  html(isEvent, data) {
    ...
    return (
      mod +
      `
<voice-channel-input dropdownLabel="AFK Channel" selectId="channel" variableContainerId="varNameContainer" variableInputId="varName"></voice-channel-input>
<br><br><br><br>
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.setAFKChannel(channel, reason);
    } catch (err) {
