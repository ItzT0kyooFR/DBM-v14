module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/set_member_nickname.js",
  },
  ...
  fields: ["server", "varName", "member", "varName2", "nickname", "reason"],
...
<br><br><br>
<span class="dbminputlabel">Nickname</span>
<input id="nickname" placeholder="Leave blank for none..." class="round" type="text">
<br>
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.members.edit(member, { nick: nickname, reason });
    } catch (err) {
