module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/change_server.js",
  },
  ...
  html(isEvent, data) {
    ...
    return (
      mod +
      `
<server-input dropdownLabel="Change Server To" selectId="server" variableContainerId="varNameContainer" variableInputId="varName"></server-input>
`
    );
  },
