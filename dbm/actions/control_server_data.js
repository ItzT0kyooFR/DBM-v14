module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/control_server_data.js",
  },
...
`
  ...
  async action(cache) {
    ...
    if (changeType === "0") {
      server.setData(dataName, value);
    } else if (changeType === "1") {
      server.addData(dataName, value);
    } else if (changeType === "2") {
      server.subtractData(dataName, value);
    }
