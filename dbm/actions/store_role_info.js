module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/store_role_info.js",
  },
  ...
  async action(cache) {
    ...
    switch (info) {
      ...
      case 8:
        ...
        break;
      case 9:
        result = [...role.members.values()];
        break;
      case 10:
        result = role.createdAt;
        break;
      case 11:
        result = role.permissions.toArray();
        break;
      case 12:
        result = role.members.size;
        break;
      case 13:
        result = role.iconURL({
          dynamic: true,
