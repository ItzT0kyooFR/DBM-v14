module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/create_stage_voice_channel.js",
  },
...
<div style="float: right; width: 49%;">
  ...
  <input id="bitrate" placeholder="Leave blank for default..." class="round" type="text">
</div>

<br><br><br>

<div style="float: left; width: 49%;">
  <span class="dbminputlabel">Members Limit</span><br>
  <input id="userLimit" class="round" type="text" placeholder="Leave blank for none...">
</div>
<div style="float: right; width: 49%;">
  <span class="dbminputlabel">RTC Region</span>
  <input id="rtcRegion" placeholder="Leave blank for auto..." class="round" type="text">
</div>
...
`
  ...
  async action(cache) {
    ...
    const bitrate =
      parseInt(this.evalMessage(data.bitrate, cache), 10) || undefined;
    const userLimit =
      parseInt(this.evalMessage(data.userLimit, cache), 10) || 0;
