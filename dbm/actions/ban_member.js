module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/ban_member.js",
  },
  ...
  fields: ["server", "varName", "member", "varName2", "reason", "days"],
...
<input id="days" placeholder="Leave blank for none..." class="round" type="text">
`
    );
  },
  ...
  async action(cache) {
    ...
    try {
      await server.members.ban(member, { reason, deleteMessageSeconds });
    } catch (err) {
