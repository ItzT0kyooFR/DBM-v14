module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/set_role_restriction.js",
  },
...
`
  ...
  async action(cache) {
    ...
    const result = interaction.member.roles.cache.has(role.id);
