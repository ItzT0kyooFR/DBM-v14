module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/reset_member_nickname.js",
  },
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.members.edit(member, { nick: null, reason });
    } catch (err) {
