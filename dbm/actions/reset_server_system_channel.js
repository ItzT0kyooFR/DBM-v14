module.exports = {
  ...
  name: "Reset Server System Channel",
  ...
  subtitle(data, presets) {
    return `Resets the Server's System Channel`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/reset_server_system_channel.js",
  },
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.setSystemChannel(null, reason);
    } catch (err) {
