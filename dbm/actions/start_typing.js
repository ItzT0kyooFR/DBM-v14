module.exports = {
  ...
  subtitle(data, presets) {
    return `Start typing in ${presets.getChannelText(
      data.storage,
      data.varName,
    )}`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/start_typing.js",
  },
  ...
  html() {
    ...
    return (
      mod +
      `
<channel-input dropdownLabel="Channel" selectId="storage" variableContainerId="varNameContainer" variableInputId="varName"></channel-input>
`
    );
  },
