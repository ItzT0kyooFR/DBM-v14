module.exports = {
  ...
  name: "Set Server Public Updates Channel",
  displayName: "Set Server Updates Channel",
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/set_server_public_updates_channel.js",
  },
  ...
  html(isEvent, data) {
    ...
    return (
      mod +
      `
<channel-input dropdownLabel="Updates Channel" selectId="channel" variableContainerId="varNameContainer" variableInputId="varName"></channel-input>
<br><br><br><br>
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.setPublicUpdatesChannel(channel, reason);
    } catch (err) {
