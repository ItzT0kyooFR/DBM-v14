module.exports = {
  ...
  subtitle(data, presets) {
    return `${data.nickname || "Reset Nickname"}`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/set_bot_nickname.js",
  },
...
<input id="nickname" class="round" type="text" placeholder="Leave blank for default...">
`
    );
  },
