module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/set_server_rules_channel.js",
  },
  ...
  html(isEvent, data) {
    ...
    return (
      mod +
      `
<channel-input dropdownLabel="Rules Channel" selectId="channel" variableContainerId="varNameContainer" variableInputId="varName"></channel-input>
<br><br><br><br>
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.setRulesChannel(channel, reason);
    } catch (err) {
