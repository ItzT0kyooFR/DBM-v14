module.exports = {
  ...
  subtitle(data) {
    return `Split "${data.textToSplit}" on "${data.splitOn}"`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/split_text.js",
  },
  ...
  fields: ["textToSplit", "splitOn", "storage", "varName"],
  ...
  html() {
    ...
    return (
      mod +
      `
<span class="dbminputlabel">Text to Split</span>
<textarea id="textToSplit" rows="3" placeholder="Insert text here..." style="white-space: nowrap; resize: none;"></textarea>
<br>
<span class="dbminputlabel">Split On</span>
...
`
  ...
  action(cache) {
    ...
    const textToSplit = this.evalMessage(data.textToSplit, cache);
