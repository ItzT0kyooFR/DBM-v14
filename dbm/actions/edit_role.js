module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/edit_role.js",
  },
...
<div style="float: right; width: calc(50% - 12px);">
	<span class="dbminputlabel">Primary Color</span>
	<input id="primaryColor" class="round" type="text" placeholder="Leave blank to not edit!"><br>
...
`
  ...
  async action(cache) {
    ...
    if (data.primaryColor) {
      roleData.colors = {
        primaryColor: this.evalMessage(data.primaryColor, cache),
      };
    }
    if (data.position) {
    ...
    try {
      await role.edit(roleData, reason);
    } catch (err) {
