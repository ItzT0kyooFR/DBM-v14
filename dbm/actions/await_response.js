module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/await_response.js",
  },
  ...
  <div style="background: rgba(0,0,0,0.25); border: 1px solid rgba(255,255,255,0.5); padding: 10px; border-radius: 5px; margin-bottom: 10px;">
    <div class="codeblock">
      <span style="color:#9b9b9b">
        ...
        <li>content === 'insert content here'</li>
...
<br><br><br>
<store-in-variable allowNone dropdownLabel="Store Message/List In" selectId="storage2" variableContainerId="varNameContainer2" variableInputId="varName2"></store-in-variable>
<br><br><br><br>
