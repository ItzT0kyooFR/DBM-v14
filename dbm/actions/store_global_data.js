module.exports = {
  ...
  subtitle(data, presets) {
    return `Globals -> ${presets.getVariableText(data.storage, data.varName2)}`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/store_global_data.js",
  },
  ...
  fields: ["dataName", "defaultVal", "storage", "varName2"],
...
`
  ...
  async action(cache) {
    ...
    let result;
    if (defVal === undefined) result = Globals.data(dataName);
    else result = Globals.data(dataName, defVal);
