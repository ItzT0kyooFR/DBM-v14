module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/timeout_member.js",
  },
  ...
  fields: ["server", "varName", "member", "varName2", "duration", "reason"],
...
<br><br><br>
<span class="dbminputlabel">Duration (w/d/h/m/s)</span>
<input id="duration" placeholder="Leave blank for 1h..." class="round" type="text">
<br>
...
`
  ...
  async action(cache) {
    ...
    const durationText = this.evalMessage(data.duration, cache) || "1h";

    //≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡
    // * Timeout Member
    //≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡

    const duration = this.convertTimeToTimestamp(durationText);

    try {
      const until = new Date(Date.now() + duration);
      await server.members.edit(member, {
