module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/find_member.js",
  },
  ...
  fields: ["server", "varName", "info", "find", "storage", "varName2"],
...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
            ...
            <option value="5">Member Role</option>
            <option value="6">Highest Role</option>
            <option value="7">Online Status</option>
            <option value="8">Nickname</option>
		</select>
	</div>
...
<br><br><br>
<store-in-variable style="padding-top: 8px;" dropdownLabel="Store In" selectId="storage" variableContainerId="varNameContainer2" variableInputId="varName2" selectWidth="40%" variableInputWidth="55%"></store-in-variable>
`
    );
  },
  ...
  async action(cache) {
    ...
    switch (info) {
      ...
      case 4:
        ...
        break;
      case 5:
        result = members.find((m) =>
          m.roles.cache.some((r) => r.name === find),
        );
        break;
      case 6:
        result = members.find((m) => m.roles.highest?.name === find);
        break;
      case 7:
        result = members.find((m) => m.presence?.status === find.toLowerCase());
        break;
      case 8:
        result = members.find((m) => m.nickname === find);
        break;
      default:
        break;
    }
