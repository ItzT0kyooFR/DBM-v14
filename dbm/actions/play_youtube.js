module.exports = {
  ...
  html(isEvent, data) {
    ...
    return (
      ...
      `
<div>
	<span class="dbminputlabel">YouTube URL</span>
	<input id="url" class="round" type="text" value="https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=RDdQw4w9WgXcQ&start_radio=1"><br>
</div>
<div style="float: left; width: calc(50% - 12px);">
  <span class="dbminputlabel">Volume (0 = min; 100 = max)</span>
  <input id="volume" class="round" type="text" placeholder="Leave blank for auto..."><br>
  <span class="dbminputlabel">Bitrate</span>
  <input id="bitrate" class="round" type="text" placeholder="Leave blank for auto...">
</div>
<div style="float: right; width: calc(50% - 12px);">
  <span class="dbminputlabel">Seek Position</span>
  <input id="seek" class="round" type="text" value="0"><br>
</div>
<br><br><br><br><br><br><br>
<div>
	<span class="dbminputlabel">Play Type</span>
