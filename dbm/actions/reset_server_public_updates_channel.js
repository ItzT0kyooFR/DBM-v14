module.exports = {
  ...
  name: "Reset Server Public Updates Channel",
  displayName: "Reset Server Updates Channel",
  ...
  subtitle(data, presets) {
    return `Resets the Server's Public Updates Channel`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/reset_server_public_updates_channel.js",
  },
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.setPublicUpdatesChannel(null, reason);
    } catch (err) {
