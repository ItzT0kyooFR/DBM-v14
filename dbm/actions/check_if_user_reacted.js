module.exports = {
  ...
  subtitle(data, presets) {
    ...
    return `${presets.getMemberText(data.member, data.varName)} - ${
      reaction[parseInt(data.reaction, 10) - 1]
    }`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/check_if_user_reacted.js",
  },
...
<br><br><br><br>
<retrieve-from-variable dropdownLabel="Reaction" selectId="reaction" variableContainerId="varNameContainer2" variableInputId="varName2"></retrieve-from-variable>
<br><br><br>
<conditional-input id="branch" style="padding-top: 8px;"></conditional-input>`
  ...
  async action(cache) {
    ...
    let result;
    if (reaction) {
      const user = await reaction.users.fetch(member.id).catch(() => null);
      result = !!user;
    } else {
      result = false;
    }
