module.exports = {
  ...
  subtitle(data, presets) {
    return `${
      data.archive === "true" ? "Archive" : "Unarchive"
    } Thread: "${presets.getChannelText(data.thread, data.threadVarName)}"`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/archive_thread.js",
  },
...
<div style="float: right; width: calc(50% - 12px);">
  ...
  async action(cache) {
    ...
    try {
      await thread.setArchived(archive, reason);
    } catch (err) {
