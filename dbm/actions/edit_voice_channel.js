module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/edit_voice_channel.js",
  },
  ...
  html(isEvent, data) {
    ...
    return (
      mod +
      `
<channel-input dropdownLabel="Channel to Edit" selectId="channel" variableContainerId="varNameContainer" variableInputId="varName"></channel-input>
<br><br><br><br>
<tab-system>
<tab label="General" icon="comments">
<div style="float: left; width: 100%;">
  <span class="dbminputlabel">Channel Name</span>
  <input id="channelName" class="round" type="text" placeholder="Leave blank for none...">
</div>
<br><br><br>
<div style="float: left; width: 49%;">
  <span class="dbminputlabel">Channel Position</span>
  <input id="channelPosition" class="round" type="text" placeholder="Leave blank for none...">
</div>
<div style="float: right; width: 49%;">
  <span class="dbminputlabel">Category Parent ID</span>
  <input id="parent" placeholder="Leave blank for none..." class="round" type="text">
</div>
<br><br><br>
...
<div style="float: left; width: 49%;">
  <span class="dbminputlabel">SlowMode (in seconds)</span>
  <input id="slowMode" class="round" type="text" placeholder="Leave blank for none...">
</div>
<div style="float: right; width: 49%;">
  <span class="dbminputlabel">Bitrate</span>
  <input id="bitrate" placeholder="Leave blank for none..." class="round" type="text">
</div>
<br><br><br>
<div style="float: left; width: 49%;">
  <span class="dbminputlabel">Members Limit</span>
  <input id="userLimit" class="round" type="text" placeholder="Leave blank for none...">
</div>
<div style="float: right; width: 49%;">
  <span class="dbminputlabel">RTC Region</span>
  <input id="rtcRegion" placeholder="Leave blank for none..." class="round" type="text">
</div>
<br><br><br>
...
`
  ...
  async action(cache) {
    ...
    const channelName = this.evalMessage(data.channelName, cache) || undefined;
    const pos = parseInt(this.evalMessage(data.channelPosition, cache), 10);
    const channelPosition = isNaN(pos) ? undefined : pos;
    const nsfw = typeof data.nsfw === "boolean" ? data.nsfw : undefined;
    const parentId = this.evalMessage(data.parent, cache) || undefined;
    const sm = parseInt(this.evalMessage(data.slowMode, cache), 10);
    const slowMode = isNaN(sm) ? undefined : sm;
    const br = parseInt(this.evalMessage(data.bitrate, cache), 10);
    const bitrate = isNaN(br) ? undefined : br;
    const ul = parseInt(this.evalMessage(data.userLimit, cache), 10);
    const userLimit = isNaN(ul) ? undefined : ul;
    const reason = this.evalMessage(data.reason, cache) || undefined;
    const rtcRegion = this.evalMessage(data.rtcRegion, cache) || undefined;
