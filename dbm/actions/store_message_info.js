module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/store_message_info.js",
  },
...
<div style="padding-top: 8px;">
	...
	<select id="info" class="round">
		...
		<option value="2">Message Content</option>
        ...
        <option value="23">Message Author Is Bot?</option>
        <option value="24">Message Flags</option>
	</select>
</div>
