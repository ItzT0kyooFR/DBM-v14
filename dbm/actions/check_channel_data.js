module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/check_channel_data.js",
  },
  ...
  fields: ["channel", "varName", "dataName", "comparison", "value", "branch"],
...
`
  ...
  async action(cache) {
    ...
    if (channel?.data) {
      ...
      const val1 = channel.data(dataName);
