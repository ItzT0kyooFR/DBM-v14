module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/control_member_data.js",
  },
...
`
  ...
  async action(cache) {
    ...
    if (changeType === "0") {
      member.setData(dataName, value);
    } else if (changeType === "1") {
      member.addData(dataName, value);
    } else if (changeType === "2") {
      member.subtractData(dataName, value);
    }
