module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/check_if_file_exists.js",
  },
...
<conditional-input id="branch" style="padding-top: 8px;"></conditional-input>`
  ...
  action(cache) {
    ...
    let result;
    if (path) result = existsSync(path);
    else this.displayError(data, cache, "Path is missing!");
