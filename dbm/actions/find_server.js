module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/find_server.js",
  },
...
<div>
	<div style="float: left; width: 40%;">
		...
		<select id="info" class="round">
            ...
            <option value="4">Creation Date</option>
...
<store-in-variable style="padding-top: 8px;" dropdownLabel="Store In" selectId="storage" variableContainerId="varNameContainer" variableInputId="varName" selectWidth="40%" variableInputWidth="55%"></store-in-variable>`
  ...
  action(cache) {
    ...
    switch (info) {
      ...
      case 4:
        result = servers.find(
          (s) => s.createdAt.getTime() === new Date(find).getTime(),
        );
        break;
      case 5:
