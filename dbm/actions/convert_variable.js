module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/convert_variable.js",
  },
  ...
  html() {
    ...
    return (
      mod +
      `
<retrieve-from-variable allowSlashParams dropdownLabel="Variable to Convert" selectId="storage" variableContainerId="varNameContainer" variableInputId="varName"></retrieve-from-variable>
<br><br><br>
<div style="padding-top: 8px; width: 35%;">
  ...
  <select id="conversion" class="round">
    ...
    <option value="7">Boolean (Non-Empty String)</option>
  </select>
</div>
<br>
...
`
  ...
  action(cache) {
    ...
    switch (conversion) {
      ...
      case 7:
        result =
          typeof variable === "string" ? variable.length > 0 : variable != null;
        break;
      default:
        break;
    }
