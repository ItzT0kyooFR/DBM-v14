module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/store_member_data.js",
  },
...
`
  ...
  async action(cache) {
    ...
    let result;
    if (defVal === undefined) result = member.data(dataName);
    else result = member.data(dataName, defVal);
