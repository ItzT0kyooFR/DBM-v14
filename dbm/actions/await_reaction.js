...
<br><br><br>
<span class="dbminputlabel">JavaScript Filter
<help-icon dialogTitle="Filter Examples" dialogWidth="550" dialogHeight="350">
  <div style="background: rgba(0,0,0,0.25); border: 1px solid rgba(255,255,255,0.5); padding: 10px; border-radius: 5px; margin-bottom: 10px;">
    <div class="codeblock">
      <span style="color:#9b9b9b">
        ...
        <li>user // The user that reacted</li><br>
        <span><b>Reaction Examples:</b></span>
        <li>reaction.emoji.name === '👌'</li>
...
<div style="float: left; width: 49%;">
  ...
  <input id="max" class="round" type="text" value="1" placeholder="Optional">
</div>
<div style="float: right; width: 49%;">
  <span class="dbminputlabel">Max Time (milliseconds)</span>
  <input id="time" class="round" type="text" value="60000" placeholder="Optional">
</div>
<br><br><br>
<div style="float: left; width: 49%;">
  <span class="dbminputlabel">Max Emojis</span>
  <input id="maxEmojis" class="round" type="text" placeholder="Optional">
</div>
<div style="float: right; width: 49%;">
  <span class="dbminputlabel">Max Users</span>
  <input id="maxUsers" class="round" type="text" placeholder="Optional">
</div>
<br><br><br>
<store-in-variable allowNone dropdownLabel="Store Reaction/List In" selectId="storage2" variableContainerId="varNameContainer2" variableInputId="varName2"></store-in-variable>
<br><br><br>
  ...
  async action(cache) {
    ...
    if (msg) {
      ...
      const filter = (reaction, user) => {
        ...
        const serverVars = server
          ? Actions.getActionVariable.bind(Actions.server[server.id])
          : null;
        try {
      ...
      try {
        const c = await msg.awaitReactions({
          filter,
          max,
          maxEmojis,
          maxUsers,
