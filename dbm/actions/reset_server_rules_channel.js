module.exports = {
  ...
  name: "Reset Server Rules Channel",
  ...
  subtitle(data, presets) {
    return `Resets the Server's Rules Channel`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/reset_server_rules_channel.js",
  },
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.setRulesChannel(null, reason);
    } catch (err) {
