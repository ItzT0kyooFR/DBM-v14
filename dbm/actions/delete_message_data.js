module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/delete_message_data.js",
  },
  ...
  fields: ["message", "varName", "dataName"],
...
`
  ...
  async action(cache) {
    ...
    const dataName = this.evalMessage(data.dataName, cache) || undefined;
    message.clearData(dataName);
