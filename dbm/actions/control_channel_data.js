module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/control_channel_data.js",
  },
...
`
  ...
  async action(cache) {
    ...
    if (changeType === "0") {
      channel.setData(dataName, value);
    } else if (changeType === "1") {
      channel.addData(dataName, value);
    } else if (changeType === "2") {
      channel.subtractData(dataName, value);
    }
