module.exports = {
  ...
  subtitle(data) {
    return `Creating a webhook: ${data.webhookName || "Captain Hook"}`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/create_webhook.js",
  },
...
<input id="webhookName" class="round" type="text" placeholder="Leave blank for default...">
<br>
<span class="dbminputlabel">Webhook Avatar (url/path/buffer)</span>
<input id="webhookAvatar" class="round" type="text" placeholder="Leave blank for default...">
<br>
<span class="dbminputlabel">Reason</span>
<input id="webhookReason" class="round" type="text" placeholder="Leave blank for none...">
<br>
...
`
  ...
  async action(cache) {
    ...
    const name = this.evalMessage(data.webhookName, cache) || "Captain Hook";
    const avatar = this.evalMessage(data.webhookAvatar, cache) || undefined;
    const reason = this.evalMessage(data.webhookReason, cache) || undefined;
    try {
