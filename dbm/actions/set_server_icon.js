module.exports = {
  ...
  subtitle(data, presets) {
    return `${data.icon || "No Image Provided!"}`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/set_server_icon.js",
  },
  ...
  html(isEvent, data) {
    ...
    return (
      mod +
      `
<span class="dbminputlabel">Icon Image</span>
<input id="icon" class="round" type="text" placeholder="Local path / image url / image buffer">
`
    );
  },
