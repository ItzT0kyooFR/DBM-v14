module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/store_server_data.js",
  },
...
`
  ...
  async action(cache) {
    ...
    let result;
    if (defVal === undefined) result = server.data(dataName);
    else result = server.data(dataName, defVal);
