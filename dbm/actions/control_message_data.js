module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/control_message_data.js",
  },
...
`
  ...
  async action(cache) {
    ...
    if (changeType === "0") {
      message.setData(dataName, value);
    } else if (changeType === "1") {
      message.addData(dataName, value);
    } else if (changeType === "2") {
      message.subtractData(dataName, value);
    }
