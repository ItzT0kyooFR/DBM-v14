module.exports = {
  ...
  subtitle(data, presets) {
    let type;
    if (data.changeType === "0") type = "=";
    else if (data.changeType === "1") type = "+";
    else if (data.changeType === "2") type = "-";
    return `(${data.dataName}) ${type} ${data.value}`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/control_global_data.js",
  },
...
`
  ...
  async action(cache) {
    ...
    if (!Globals) return this.callNextAction(cache);
    ...
    if (changeType === "0") {
      Globals.setData(dataName, value);
    } else if (changeType === "1") {
      Globals.addData(dataName, value);
    } else if (changeType === "2") {
      Globals.subtractData(dataName, value);
    }
