module.exports = {
  ...
  subtitle(data, presets) {
    return `${data.avatar || "No Image Provided!"}`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/set_bot_avatar.js",
  },
  ...
  html(isEvent, data) {
    ...
    return (
      mod +
      `
<span class="dbminputlabel">Avatar Image</span>
<input id="avatar" class="round" type="text" placeholder="Local path / image url / image buffer">
`
    );
  },
  ...
  async action(cache) {
    ...
    const avatar = this.evalMessage(data.avatar, cache);
