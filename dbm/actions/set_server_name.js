module.exports = {
  ...
  subtitle(data, presets) {
    return `${data.serverName || "Enter Server Name!"}`;
  },
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/set_server_name.js",
  },
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.setName(serverName, reason);
    } catch (err) {
