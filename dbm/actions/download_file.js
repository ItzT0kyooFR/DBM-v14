module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/shadoow051/DBM-v14/blob/main/bot/actions/download_file.js",
  },
...
<div style="float: left;">
  <div style="float: left; width: 55%;">
    ...
    <input id="fileName" class="round" type="text" style="width: 400px" value="file" placeholder="Leave blank for 'file'...">
  </div>
  <div style="float: right; width: 40%; padding-left: 100px;">
    <span class="dbminputlabel">File Format</span>
    <input id="fileFormat" class="round" type="text" style="width: 100px" value="txt" placeholder="'txt'">
  </div>
</div>
<br><br><br><br>
<span class="dbminputlabel">File Path</span>
<input id="filePath" class="round" type="text" value="./downloads" placeholder="Leave blank for './downloads'...">
`
    );
  },
  ...
  async action(cache) {
    ...
    const fileName = this.evalMessage(data.fileName, cache) || "file";
    const fileFormat = this.evalMessage(data.fileFormat, cache) || "txt";
    const filePath = this.evalMessage(data.filePath, cache) || "./downloads";
    const fullPath = `${filePath}/${fileName}.${fileFormat}`;
