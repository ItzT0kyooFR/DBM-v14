module.exports = {
  ...
  subtitle(data) {
    if (data.message?.length > 0) {
      return `<font color="${data.color}">${data.message}</font>`;
    }
...
<br>
<span class="dbminputlabel">Console Log Type</span><br>
<select id="logType" class="round" style="width: 50%;">
	<option value="0" selected>Console Log</option>
	<option value="1">Console Info</option>
  <option value="2">Console Warn</option>
  <option value="3">Console Error</option>
  <option value="4">Console Debug</option>
</select>
<br>
<span class="dbminputlabel">Message To Send</span>
<textarea id="message" rows="10" style="width: 99%; font-family: monospace; white-space: nowrap;"></textarea>
`
    );
  },
  ...
  action(cache) {
    ...
    const { default: chalk } = Bot.require("chalk");
    ...
    switch (logType) {
      case "0":
        ...
        break;
      case "1":
        console.info(chalk.hex(color)(message));
        break;
      case "2":
        console.warn(chalk.hex(color)(message));
        break;
      case "3":
        console.error(chalk.hex(color)(message));
        break;
      case "4":
        console.debug(chalk.hex(color)(message));
        break;
      default:
        console.log(chalk.hex(color)(message));
    }
