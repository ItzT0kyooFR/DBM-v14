...
<select id="info" class="round">
  ...
  <option value="7">Includes @here Mention?</option>
  <option value="8">Includes @member Mention?</option>
  <option value="9">Includes @role Mention?</option>
  <option value="10">Includes @channel Mention?</option>
  <option value="11">Has Attachments?</option>
  <option value="12">Has Embeds?</option>
  <option value="13">Has Components?</option>
  <option value="14">Is From Bot?</option>
  <option value="15">Is Reply?</option>
  <option value="16">Is In Thread?</option>
  <option value="17">Is Ephemeral?</option>
  <option value="18">Has Stickers?</option>
</select>
<br><br><br>
  ...
  async action(cache) {
    ...
    switch (info) {
      ...
      case 6:
        ...
        break;
      case 7:
        result = msg.content?.includes("@here");
        break;
      case 8:
        result = msg.mentions.users.size > 0;
        break;
      case 9:
        result = msg.mentions.roles.size > 0;
        break;
      case 10:
        result = msg.mentions.channels.size > 0;
        break;
      case 11:
        result = msg.attachments.size > 0;
        break;
      case 12:
        result = msg.embeds.length > 0;
        break;
      case 13:
        result = msg.components.length > 0;
        break;
      case 14:
      ...
      case 15:
        ...
        break;
      case 16:
        result = msg.channel?.isThread();
        break;
      case 17:
        result = msg.flags?.has(MessageFlags.Ephemeral);
        break;
      case 18:
        result = msg.stickers.size > 0;
        break;
    }
