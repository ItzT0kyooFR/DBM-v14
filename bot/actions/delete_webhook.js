module.exports = {
  ...
  subtitle(data) {
    return `Deleting a webhook: ${data.varName || "No Webhook"}`;
  },
  ...
  html() {
    ...
    return (
      mod +
      `
<retrieve-from-variable dropdownLabel="Webhook to Delete" selectId="webhook" variableContainerId="varNameContainer" variableInputId="varName"></retrieve-from-variable>
`
    );
  },
  ...
  async action(cache) {
    ...
    const webhook = this.getVariable(type, varName, cache);
