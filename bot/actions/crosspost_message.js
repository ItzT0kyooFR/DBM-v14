module.exports = {
  ...
  html() {
    ...
    return (
      mod +
      `
<message-input dropdownLabel="Message to Crosspost" selectId="message" variableContainerId="varNameContainer" variableInputId="varName"></message-input>
`
    );
  },
  ...
  async action(cache) {
    ...
    try {
      message = await message.crosspost();
      this.storeValue(
        message,
