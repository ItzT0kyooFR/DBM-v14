  ...
  async action(cache) {
    ...
    switch (info) {
      ...
      case 4: // User Amount
        ...
        break;
      case 5: // Rounded Ping
        result = Math.round(client.ws.ping);
        break;
      ...
      case 8: // Bots' Token
        ...
        break;
      case 9: // Voice Connections Amount
        result = client.voice.adapters.size;
        break;
      case 10: // Total Amount of Channels
      ...
      case 16: // Bot Guilds Objects
        ...
        break;
      case 17: // Bot Guilds Names
        result = client.guilds.cache.map((g) => g.name);
        break;
      case 18: // Bot Guilds IDs
        result = client.guilds.cache.map((g) => g.id);
        break;
      case 19: // Bot Current Prefix
      ...
      case 45: // Are Commands Case Sensitive?
        ...
        break;
      case 46: // Last Message ID
        result = client.user.lastMessageID;
        break;
