module.exports = {
  ...
  fields: ["storage", "varName", "commandToRun"],
  ...
  html() {
    ...
    return (
      mod +
      `
Run a command in your console.<strong> THIS IS VERY DANGEROUS. SET THIS TO "BOT OWNER ONLY"</strong>
<br><br>
<span class="dbminputlabel">Command to Run</span>
<input id="commandToRun" class="round" type="text">
<br><br><br>
...
`
  ...
  action(cache) {
    ...
    try {
      const commandToRun = this.evalMessage(data.commandToRun, cache);
      const response = execSync(commandToRun, {
        encoding: "utf8",
