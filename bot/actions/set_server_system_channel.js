module.exports = {
  ...
  name: "Set Server System Channel",
  ...
  html(isEvent, data) {
    ...
    return (
      mod +
      `
<channel-input dropdownLabel="System Channel" selectId="channel" variableContainerId="varNameContainer" variableInputId="varName"></channel-input>
<br><br><br><br>
...
`
  ...
  async action(cache) {
    ...
    try {
      await server.setSystemChannel(channel, reason);
    } catch (err) {
