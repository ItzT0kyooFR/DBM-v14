module.exports = {
  ...
  subtitle(data) {
    return `Translate from '${data.translateFrom}' to '${data.translateTo}'`;
  },
...
<div style="float: left; width: 25%; padding-right: 10px;">
  <span class="dbminputlabel">Translate from</span>
  <input id="translateFrom" placeholder="ISO Code" class="round" type="text" maxlength="2">
</div>
<div style="float: left; width: 25%">
  <span class="dbminputlabel">Translate to</span>
  <input id="translateTo" placeholder="ISO Code" class="round" type="text" maxlength="2">
</div>
<div style="float: right; width: 45%; padding-top: 10px;">
  <u>Note:</u><br>Find ISO Codes <a target="_blank" href="https://phyrok.github.io/iso_codes.html">Here</a>
</div>
<br><br><br>
<span class="dbminputlabel">Message to Translate</span>
...
`
  ...
  async action(cache) {
    ...
    const translate = Bot.require("translate").default;
    translate.engine = "google";
    const translateFrom = this.evalMessage(data.translateFrom, cache) || "en";
    const translateTo = this.evalMessage(data.translateTo, cache) || "en";
    const translateMessage = this.evalMessage(data.translateMessage, cache);
    if (!translateMessage || !translateFrom || !translateTo) {
      return this.callNextAction(cache);
    }
    try {
      const result = await translate(translateMessage, {
        from: translateFrom,
        to: translateTo,
      });
