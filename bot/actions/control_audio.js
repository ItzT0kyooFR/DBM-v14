...
<div style="float: left; width: 80%;">
	<span class="dbminputlabel">Audio Action</span>
	<select id="action" class="round">
        ...
        <option value="3">Skip Audio</option>
        <option value="4">Play Previous Audio</option>
  ...
  action(cache) {
    ...
    switch (action) {
      ...
      case 3:
        ...
        break;
      case 4:
        Audio.previous(cache);
        break;
      case 5:
        Audio.clearQueue(cache);
        break;
      case 6:
        Audio.setVolume(volume, cache);
        break;
      case 7:
        Audio.setBitrate(bitrate, cache);
        break;
    }
