module.exports = {
  ...
  fields: ["categoryName", "categoryPosition", "reason", "storage", "varName2"],
  ...
  html(isEvent, data) {
    ...
    return (
      mod +
      `
<span class="dbminputlabel">Category Name</span><br>
<input id="categoryName" class="round" type="text">
<br>
<span class="dbminputlabel">Category Position</span><br>
<input id="categoryPosition" class="round" type="text" placeholder="Leave blank for default...">
<br>
<span class="dbminputlabel">Reason</span>
<input id="reason" class="round" type="text" placeholder="Leave blank for none...">
<br><br><br>
<store-in-variable dropdownLabel="Store Category In" allowNone selectId="storage" variableInputId="varName2" variableContainerId="varNameContainer2"></store-in-variable>
`
    );
  },
  ...
  async action(cache) {
    ...
    const categoryName =
      this.evalMessage(data.categoryName, cache) || "category";
    ...
    try {
      ...
      this.storeValue(category, storage, varName2, cache);
    } catch (error) {
