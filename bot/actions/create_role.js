...
<div style="float: right; width: 50%;">
	<span class="dbminputlabel">Primary Color</span><br>
	<input id="primaryColor" class="round" type="text" placeholder="Leave blank for default!">
  <br>
...
<store-in-variable allowNone selectId="storage" variableInputId="varName" variableContainerId="varNameContainer"></store-in-variable>`
  ...
  async action(cache) {
    ...
    roleData.reason = this.evalMessage(data.reason, cache) || undefined;
