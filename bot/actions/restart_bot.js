...
<input id="filename" class="round" type="text" value="bot.js" placeholder="Default is bot.js...">
<br>
<div>
  <p>
    <u>Warning:</u><br>
...
`
  ...
  async action(cache) {
    ...
    const filename = this.evalMessage(data.filename, cache) || "./bot.js";
    const path = require("path");
    const client = this.getClient();
    console.log("Restarting Bot...");
    await client.destroy();
    const botPath = path.join(process.cwd(), filename);
