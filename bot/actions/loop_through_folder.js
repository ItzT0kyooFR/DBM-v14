module.exports = {
  ...
  subtitle() {
    return "Loops through folder and stores filenames in a variable";
  },
  ...
  fields: ["folderPath", "storage", "varName2"],
...
<input id="folderPath" class="round" type="text" placeholder="e.g. ./resources/images">
<br><br>
...
`
  ...
  async action(cache) {
    ...
    const path = this.evalMessage(data.folderPath, cache);
    try {
      if (path) {
