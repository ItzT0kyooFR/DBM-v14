...
<div style="padding-top: 8px; width: 80%;">
      ...
      <option value="0" selected>String (Text)</option>
      ...
      <option value="7">BitInt</option>
      <option value="8">Interaction</option>
      <option value="9">Server</option>
      <option value="10">Role</option>
      <option value="11">Member</option>
      <option value="12">Message</option>
      <option value="13">Emoji</option>
      <option value="14">Sticker</option>
      <option value="15">Image</option>
      <option value="16">Any Channel</option>
      <option value="17">Text Channel</option>
      <option value="18">DM Channel</option>
      <option value="19">Group DM Channel</option>
      <option value="20">Voice Channel</option>
      <option value="21">Stage Voice Channel</option>
      <option value="22">Category Channel</option>
      <option value="23">Announcement Channel</option>
      <option value="24">Forum Channel</option>
      <option value="25">Public Thread Channel</option>
      <option value="26">Private Thread Channel</option>
		</select>
</div>
<br>
<hr class="subtlebar">
    ...
    if (variable) {
      ...
      switch (compare) {
        ...
        case 1:
          ...
          break;
        case 2:
          result = typeof variable === "boolean";
          break;
        case 3:
        ...
        case 4:
          ...
          break;
        case 5:
          result = typeof variable === "object";
          break;
        case 6:
          result = Array.isArray(variable);
          break;
        case 7:
          result = typeof variable === "bigint";
          break;
        case 8:
          result = variable instanceof BaseInteraction;
          break;
        case 9:
          result = variable instanceof Guild;
          break;
        case 10:
          result = variable instanceof Role;
          break;
        case 11:
          result = variable instanceof GuildMember || variable instanceof User;
          break;
        case 12:
          result = variable instanceof Message;
          break;
        case 13:
          result = variable instanceof GuildEmoji || variable instanceof Emoji;
          break;
        case 14:
          result = variable instanceof Sticker;
          break;
        case 15:
          // image
          result = null;
          break;
        case 16:
          result = variable instanceof GuildChannel;
          break;
        case 17:
          result = variable.type === ChannelType.GuildText;
          break;
        case 18:
          result = variable.type === ChannelType.DM;
          break;
        case 19:
          result = variable.type === ChannelType.GroupDM;
          break;
        case 20:
          result = variable.type === ChannelType.GuildVoice;
          break;
        case 21:
          result = variable.type === ChannelType.GuildStageVoice;
          break;
        case 22:
          result = variable.type === ChannelType.GuildCategory;
          break;
        case 23:
          result = variable.type === ChannelType.GuildAnnouncement;
          break;
        case 24:
          result = variable.type === ChannelType.GuildForum;
          break;
        case 25:
          result = variable.type === ChannelType.PublicThread;
          break;
        case 26:
          result = variable.type === ChannelType.PrivateThread;
          break;
      }
    }
