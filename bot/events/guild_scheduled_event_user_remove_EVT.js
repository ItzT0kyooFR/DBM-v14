module.exports = {
  ...
  fields: [
    "Temp Variable Name (stores scheduled event):",
    "Temp Variable Name (stores user who left):",
  ],
  ...
  mod(DBM) {
    ...
    DBM.Events.guildScheduledEventUserRemove =
      async function guildScheduledEventUserRemove(event, user) {
