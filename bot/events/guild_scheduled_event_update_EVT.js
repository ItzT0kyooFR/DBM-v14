module.exports = {
  ...
  fields: [
    "Temp Variable Name (stores old scheduled event):",
    "Temp Variable Name (stores new scheduled event):",
  ],
  ...
  mod(DBM) {
    ...
    DBM.Events.guildScheduledEventUpdate =
      async function guildScheduledEventUpdate(oldEvent, newEvent) {
